...
#define ATTRIB_LOC_NORMAL 3
    ...
    class Mesh
    {
        ...
        glm::vec3 minBound = glm::vec3(0.0f); // Will be used in map this is the minimum bound of the 3d box covering the map obj
    ...
    public:
        ...
        {
            // instance mats are the position rotation and scale of each instance but in a
            // mat format so we only do 1 draw call for the big amount of objs, here used for the trees
            // which will be created using a greyscale image made on the map texture.
